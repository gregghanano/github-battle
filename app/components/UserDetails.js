...
function UserDetails(user){
  return (
    <div>
      ...
      <li className='list-group-item'><img src={user.info.avatar_url} className='img-rouded img-responsive'/></li>
      ...
      {user.info.blog && <li className='list-group-item'>Blog: <a href={user.info.blog} target="_blank"></a>{user.info.blog}</li>}
    </div>
  )
}
